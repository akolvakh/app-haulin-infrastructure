...
vpc_cidr                                                               = var.profile.vpc_cidr
cognito_urls                                                           = ["https://${module.label.tags["Product"]}-${module.label.tags["Environment"]}.auth.${module.label.tags["Region"]}.amazoncognito.com/login/cognito"]
...
tf_framework_component_version                                         = "${var.profile.tf_framework_component_version}_ddd_ecs_service_be"
#connections
