module "task_def" {
  ...
  container_definition_params = {
    ...
    spring_datasource_url         = "jdbc:postgresql://${var.outputs_db_db_main_entrypoint}:5432/haulin_app_${module.label.tags["Environment"]}_default?ssl=true&sslmode=require"
