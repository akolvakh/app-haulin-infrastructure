	...
	"Statement": [
		...
		},
		{
			...
			"Resource": [
				...
				"arn:aws:secretsmanager:${aws_region}:${aws_account}:secret:/${product}/${environment}/haulin*",
		...
		},
		{
			...
			"Resource": [
			    "arn:aws:ssm:${aws_region}:${aws_account}:parameter/${product}/${environment}/service_be/*"
			]
		}
	]
}
