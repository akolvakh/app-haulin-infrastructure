...
| <a name="module_lambda_post_confirmation_admin"></a> [lambda\_post\_confirmation\_admin](#module\_lambda\_post\_confirmation\_admin) | ../../../../libft/generic-modules/lambda/lambda | n/a |
| <a name="module_lambda_source_code"></a> [lambda\_source\_code](#module\_lambda\_source\_code) | ../../../../libft/lambdas/cognito-post-confirm-admin/python | n/a |

## Resources

| Name | Type |
|------|------|
| [aws_iam_policy.cognito_post_confirm_admin_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
| [aws_iam_policy.cognito_post_confirm_admin_secrets_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
| [aws_iam_role.cognito_post_confirm_admin_role](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role_policy_attachment.cognito_post_confirm_admin_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.cognito_post_confirm_admin_policy_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.cognito_post_confirm_admin_secret_policy_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| [aws_iam_policy_document.cognito_post_confirm_admin_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.cognito_post_confirm_admin_secrets_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| Name | Description |
|------|-------------|
| <a name="output_lambda_post_confirmation_admin_arn"></a> [lambda\_post\_confirmation\_admin\_arn](#output\_lambda\_post\_confirmation\_admin\_arn) | n/a |
| <a name="output_lambda_post_confirmation_admin_function_name"></a> [lambda\_post\_confirmation\_admin\_function\_name](#output\_lambda\_post\_confirmation\_admin\_function\_name) | -------------------------------------------------------------- Cognito endpoin protection -------------------------------------------------------------- |
