...
variable "outputs_sg_sg_ecs_payment_id" {}
variable "outputs_sg_sg_ecs_import_id" {}
variable "outputs_sg_sg_ecs_program_management_id" {}
variable "outputs_sg_sg_quartz_db_id" {}
variable "outputs_ecs_service_api_gateway_sg_id" {}
variable "outputs_db_db_main_entrypoint" {}
variable "outputs_db_db_quartz_entrypoint" {}
