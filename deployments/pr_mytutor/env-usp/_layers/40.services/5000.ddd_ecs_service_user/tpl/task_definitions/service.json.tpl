[
  ...
  },
  {
    ...
    "environment": [
      ...
      {
        "name": "KAFKA_APPLICATION_UPDATES_TOPIC_NAME",
        "value": "${kafka_application_updates_topic_name}"
      },
      {
        "name": "REDIS_HOSTNAME",
    ...
    "secrets": [
      ...
      {
        "valueFrom": "arn:aws:ssm:${aws_region}:${aws_account}:parameter/${product}/${environment}/service_${service_name}/tutor_onboarding_application_uri",
      ...
      {
        "name": "PLATFORM_NAME",
        "valueFrom": "arn:aws:ssm:${aws_region}:${aws_account}:parameter/${product}/${environment}/service_${service_name}/platform_name"
      }
    ],
