[
  ...
  },
  {
    ...
    "secrets": [
      ...
      {
        "valueFrom": "arn:aws:ssm:${aws_region}:${aws_account}:parameter/${product}/${environment}/service_${service_name}/lesson_management_service_url",
        "name": "LESSON_MANAGEMENT_SERVICE_URL"
      },
      {
