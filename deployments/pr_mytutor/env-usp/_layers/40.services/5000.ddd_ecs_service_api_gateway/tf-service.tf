module "service" {
  ...
  td_arn                         = module.task_def.task_def_arn // aws_ecs_task_definition.td.arn
  desired_count                  = local.autoscaling[module.label.tags["Environment"]].autoscaling_desired_task_count
