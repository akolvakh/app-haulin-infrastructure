...
class TestFunction(unittest.TestCase):
    ...
    def test_request_early_access_with_not_ajuma_email_in_prod(self):
        context = {'requestid': '456'}
        json = {
            "request": {
                "clientMetadata": {
    ...
    def test_request_early_access_with_not_ajuma_email_in_stage(self):
        context = {'requestid': '456'}
        json = {
            "request": {
                "clientMetadata": {
        ...
        with mock.patch(post_request, new=self.request_mock):
            with self.assertRaises(Exception) as exc_content:
                ...
                call_lambda(whoami(), json, context)
            self.assertIn('invalid request json - domain name is not \'ajuma.com\'', str(exc_content.exception))
